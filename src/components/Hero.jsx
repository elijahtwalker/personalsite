    ...
    <section id="home" className={`relative h-screen overflow-hidden transition-colors duration-300
      ...
      <div className="absolute bottom-12 left-12 z-10">
        ...
        >
          ...
          >
            <span className={`text-[5rem] sm:text-[8rem] md:text-[10rem] lg:text-[12rem] font-bold tracking-tighter transition-colors duration-300
              ${isDark ? 'text-hunter_green' : 'text-baby_powder'}`}>
              Elijah
            </span>
            <span className={`text-[5rem] sm:text-[8rem] md:text-[10rem] lg:text-[12rem] font-bold tracking-tighter -mt-8 sm:-mt-12 md:-mt-14 lg:-mt-16 transition-colors duration-300
              ${isDark ? 'text-hunter_green' : 'text-baby_powder'}`}>
              Walker
            </span>
          </motion.div>
