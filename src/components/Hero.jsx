    ...
    <section id="home" className={`relative h-screen overflow-hidden transition-colors duration-300
      ...
      <div className="absolute bottom-12 left-12 z-10">
        ...
        >
          ...
          >
            <span className={`text-[12rem] sm:text-[15rem] font-bold tracking-tighter transition-colors duration-300
              ${isDark ? 'text-hunter_green' : 'text-baby_powder'}`}>
              Elijah
            </span>
            <span className={`text-[12rem] sm:text-[15rem] font-bold tracking-tighter -mt-16 transition-colors duration-300
              ${isDark ? 'text-hunter_green' : 'text-baby_powder'}`}>
              Walker
            </span>
          </motion.div>
