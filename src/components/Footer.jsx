...
export default function Footer() {
  ...
  const textClass = `text-sm transition-colors duration-300 ${isDark ? 'text-mint_green/70' : 'text-baby_powder/60'}`;

  return (
    <footer className={`pt-20 pb-10 transition-colors duration-300 ${isDark ? 'bg-eerie_black' : 'bg-yinmn_blue'}`}>
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-3 items-center">
        ...
        <div className="flex items-center gap-5 justify-start">
          ...
          <a
            href="https://github.com/elijahtwalker"
            target="_blank"
            rel="noopener noreferrer"
            className={iconClass}
          >
          ...
          <a
            href="mailto:hello@elijahwalker.me"
            className={iconClass}
          >
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Center: copyright */}
        <p className={`${textClass} text-center`}>&copy; 2026 Elijah Walker</p>

        {/* Right: webring bubble */}
        <div className="flex justify-end">
          <div className={`flex items-center gap-3 px-4 py-2 rounded-full backdrop-blur-sm transition-colors duration-300
            ${isDark
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`text-sm transition-all duration-200 hover:scale-110 transform ${isDark ? 'text-mint_green hover:text-mint_green/80' : 'text-baby_powder hover:text-baby_powder/70'}`}
            >
              ←
            </a>
            <a
